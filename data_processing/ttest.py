...
if __name__ == '__main__':
    fc = pd.read_csv("/home/cosbi/KDGPT/data_processing/filter_age_output/fc_KeptGPT_under7_foranova.csv")
    kd = pd.read_csv("/home/cosbi/KDGPT/data_processing/filter_age_output/kd_KeptGPT_under7_foranova.csv")
    path = '/home/cosbi/KDGPT/data_processing/ttest_output/ttest_under7_result.csv'
    ttest(fc,kd,path)
